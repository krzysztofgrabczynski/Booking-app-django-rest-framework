...
class HotelListRetriveGenericViewSet(mixins.ListModelMixin, mixins.RetrieveModelMixin, viewsets.GenericViewSet):
    """
...
class HotelUpdateDestroyView(mixins.UpdateModelMixin, mixins.DestroyModelMixin, viewsets.GenericViewSet):
    """
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        return Response(f'Deleteing of the {instance} Hotel', status=status.HTTP_202_ACCEPTED)
